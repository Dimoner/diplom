        ...
        <div>
            ...
            >
                ...
                <div  style={{ width: "230px", marginTop: "-6px" }}>
                    ...
                    >
                        <option value={20}>1,00 нм/с</option>
                        <option value={15}>0,63 нм/с</option>
                        <option value={12}>0,50 нм/с</option>
                        <option value={10}>0,42 нм/с</option>
                        <option value={8}>0,33 нм/с</option>
                        <option value={5}>0,25 нм/с</option>
                    </NativeSelect>
                </div>
            </div>
